...
$_lang['file_upload_success'] = '<h4 style="font-weight:bold; color:green;">[+filename+] successful uploaded.</h4>';
$_lang['file_upload_error'] = '[+filename+] was not uploaded. Is the folder assets/packages writable?';
$_lang['file_upload_error_exists'] = '<h4 style="font-weight:bold; color:orange;">[+lang.package:ucfirst+] [+package+] already exists.</h4>';
